...
public class ServiceLocator {
  ...
  public Shape getRandomShape() {
    ...
    switch (version) {
    case 1:
      shape = new Shape1(Main.getGame().getBoard());
      break;
    case 2:
      shape = new Shape2(Main.getGame().getBoard());
      break;
    case 3:
      shape = new Shape3(Main.getGame().getBoard());
      break;
    case 4:
      shape = new Shape4(Main.getGame().getBoard());
      break;
    case 5:
      shape = new Shape5(Main.getGame().getBoard());
      break;
    case 6:
      shape = new Shape6(Main.getGame().getBoard());
      break;
    case 7:
      shape = new Shape7(Main.getGame().getBoard());
      break;
    }
